...
const SEED_DATA = {
  users: [
    ...
    { id: "admin-system", name: "أ. محمد", phone: "AEAdmin", role: "superadmin", governorate: "الجيزة", district: "حدائق الأهرام", password: "Aa132456", emailVerified: "verified", phoneVerified: "verified", email: "admin@harfagy.com", custom_id: "MG-0303" },
